...
import { FillableButton } from "../ui/fillable-button";
		...
		<footer className="overflow-hidden mt-auto flex flex-col-reverse md:flex-row gap-8 py-8 bg-white dark:bg-black px-4 sm:px-8 md:px-16 lg:px-32 transition-all">
			<section className="flex-1 flex flex-col gap-2">
				...
				<div className="flex gap-2">
					...
					>
						<FillableButton
							className="rounded-xs! size-10 p-0 dark:text-black dark:hover:text-white"
							inverse
							size="icon"
							overlayClassName="bg-primary dark:bg-primary"
						>
					...
					>
						<FillableButton
							className="rounded-xs! size-10 p-0 dark:text-black dark:hover:text-white"
							overlayClassName="bg-[#0072b1] dark:bg-[#0072b1]"
							inverse
							size="icon"
						>
					...
					>
						<FillableButton
							...
							className="rounded-xs! size-10 p-0 dark:text-black dark:hover:text-white"
							size="icon"
							overlayClassName="bg-[#2b3137] dark:bg-[#2b3137]"
						>
			...
			<section className="flex-1 flex flex-col">
				...
				<span className="text-sm text-zinc-500 dark:text-zinc-400">
					Código fonte:{" "}
					<FillableButton variant="link" asChild>
						<a
