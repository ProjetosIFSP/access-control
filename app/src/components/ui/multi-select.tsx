      ...
      <PopoverTrigger asChild>
        <div
          ...
          className={cn(
            ...
            "flex min-h-9 w-full items-center justify-between gap-2 rounded-3xl border px-3 py-2 text-sm",
          ...
          <div className="flex shrink-0 items-center gap-1">
            {value.length > 0 && (
              <span
                ...
                className="flex size-4 items-center justify-center rounded-full text-muted-foreground hover:text-foreground cursor-pointer"
