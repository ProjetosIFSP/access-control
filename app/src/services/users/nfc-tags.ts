...
export async function registerNfcTag(payload: RegisterNfcTagPayload): Promise<NfcTagSummary> {
...
export async function deleteNfcTag(payload: DeleteNfcTagPayload): Promise<void> {
...
export async function toggleNfcTag(payload: ToggleNfcTagPayload): Promise<NfcTagSummary> {
