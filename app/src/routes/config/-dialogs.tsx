...
import { ControllerDeleteDialog } from "./-delete-dialog";
...
interface ConfigDialogsProps {
	...
	deleteTarget: IotController | null;
			...
			<Dialog open={isAddControllerOpen} onOpenChange={onAddControllerChange}>
				<DialogContent>
					...
					<ol className="list-decimal pl-4 space-y-2 mt-4 text-sm text-muted-foreground">
						<li>
							Ligue o Controlador NFC à uma fonte de energia (ou pressione
							Reset).
						</li>
						<li>
						...
						<li>
							A tela de portal abrirá sozinha. Caso isso não ocorra, navegue
							para:{" "}
							<a
						...
						<li>
							Preencha sua rede Wi-Fi, o IP do servidor MQTT, Device Secret e
							Room ID (vazio se quiser pareamento).
						</li>
						<li>
							Salve. O controlador reiniciará conectado na sua rede e aparecerá
							na listagem!
						</li>
					</ol>
				</DialogContent>
