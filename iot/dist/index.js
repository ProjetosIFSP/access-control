...
broker.on("publish", (packet, client) => {
    ...
    if (handleTopic("register", topic, payloadString, handleRegister))
        return;
    if (handleTopic("heartbeat", topic, payloadString, handleHeartbeat))
        return;
    if (handleTopic("status", topic, payloadString, handleStatus))
        return;
...
function ensureCommandPolling(controllerId) {
